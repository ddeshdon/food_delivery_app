...
const lunchRestaurants = [
  {
    id: '1',
    name: 'Tsuru Udon',
    imageName: 'tsuru_udon.jpg',
  },
  {
    id: '2',
    name: 'Hey Gusto',
    imageName: 'hey_gusto.jpg',
  }
];

export default function LunchScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <Text style={styles.pageTitle}>Lunch</Text>
        
        {lunchRestaurants.map((restaurant) => renderRestaurant(restaurant))}
      </ScrollView>
    </SafeAreaView>
  );
}
