...
const dinnerRestaurants = [
  {
    id: '1',
    name: 'Khao Jaan-Prod',
    imageName: 'khao_jaan_prod.jpg',
  },
  {
    id: '2',
    name: 'Laem Charoen Seafood',
    imageName: 'laem_charoen_seafood.jpg',
  }
];

export default function DinnerScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <Text style={styles.pageTitle}>Dinner</Text>
        
        {dinnerRestaurants.map((restaurant) => renderRestaurant(restaurant))}
      </ScrollView>
    </SafeAreaView>
  );
}
