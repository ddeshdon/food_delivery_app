...
const beverageRestaurants = [
  {
    id: '1',
    name: 'Nose Tea',
    imageName: 'nose_tea.jpg',
  },
  {
    id: '2',
    name: 'Boost Juice',
    imageName: 'boost_juice.jpg',
  }
];

export default function BeverageScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <Text style={styles.pageTitle}>Beverage</Text>
        
        {beverageRestaurants.map((restaurant) => renderRestaurant(restaurant))}
      </ScrollView>
    </SafeAreaView>
  );
}
